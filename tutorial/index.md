...
## Apache Thrift Setup and Code Generation
...
To recursively generate source code from a Thrift file and all other Thrift files included by it, run
...
{% if item.tutorial %} - [{{item.title}}]({{item.url}}) {% endif %}
{% endfor %}
